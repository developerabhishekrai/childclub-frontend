  ...
  const fetchData = async () => {
    try {
      ...
      if (assignmentRes.ok) {
        ...
        // Teachers can now edit all assignments
        // No authorization check needed - teachers can edit any assignment
      ...
      await Swal.fire({
        icon: 'error',
        title: 'Error',
        text: 'Failed to load assignment. Please try again.',
      });
        ...
        <div className="container-fluid py-3">
          <div className="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted mb-0">Update assignment details and settings</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="card-body p-4 p-lg-5">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-5">
                    ...
                    <div className="row g-4">
                      ...
                      <div className="col-md-4">
                        ...
                        <small className="text-muted">Current status of the assignment</small>
                      </div>
                      ...
                      <div className="col-12">
                        <div className="form-check form-switch">
                          ...
                          <label className="form-check-label fw-semibold" htmlFor="isRecurring">
                            This is a recurring assignment
                          </label>
                        </div>
                      </div>
                    ...
                    {formData.assignedClasses.length > 0 && (
                      <div className="mb-4">
                        ...
                        <div className="border rounded p-4" style={{ maxHeight: '400px', overflowY: 'auto' }}>
                          {filteredStudents.length === 0 ? (
                            <p className="text-muted mb-0">No students available in selected classes</p>
                          ) : (
                            <div className="row g-3">
                                  ...
                                  <div className="form-check">
                                    ...
                                    <label className="form-check-label" htmlFor={`student-${student.id}`}>
                                      ...
                                      <small className="text-muted ms-2">
                                        ({classes.find(c => c.id === student.currentClassId)?.name || 'N/A'})
                                      </small>
                                    </label>
                                  </div>
                                </div>
                  ...
                  <div className="d-flex justify-content-between gap-3">
                    <Link href="/teacher/tasks" className="btn btn-lg btn-outline-secondary">

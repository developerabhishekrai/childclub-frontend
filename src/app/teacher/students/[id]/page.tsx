    ...
    return (
      <div className="min-vh-100 bg-light d-flex align-items-center justify-content-center">
        <div className="text-center">
          ...
          <Link href="/teacher/students" className="btn btn-primary">
    ...
    <div className="min-vh-100 bg-light">
          ...
          <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div className="d-flex align-items-center gap-3">
              ...
              <div>
                ...
                <p className="text-muted mb-0">Complete information about the student</p>
              </div>
            </div>
      ...
      <div className="container-fluid py-4">
          ...
          <div className="card-body p-4">
            <div className="row align-items-center">
              ...
              <div className="col">
                ...
                <div className="d-flex align-items-center gap-4 mt-2 text-muted">
            ...
            <div className="card border-0 shadow-sm">
              ...
              <div className="card-body">
                <div className="d-grid gap-2">
                  <Link href={`/teacher/students/${student.id}/attendance`} className="btn btn-outline-primary">
                    <CheckCircle size={18} className="me-2" />
                    View Attendance
                  </Link>
                  <Link href={`/teacher/students/${student.id}/performance`} className="btn btn-outline-success">
                    <Award size={18} className="me-2" />
                    View Performance
                  </Link>
                  <Link href={`/teacher/students/${student.id}/assignments`} className="btn btn-outline-info">
        ...
        <div className="text-center mt-4">
          <Link href="/teacher/students" className="btn btn-outline-primary btn-lg">
            <ArrowLeft size={18} className="me-2" />

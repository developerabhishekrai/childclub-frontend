        ...
        <div className="container-fluid py-3">
          <div className="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted mb-0">Set up a new task for students</p>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div className="mb-5">
                    ...
                    <div className="row g-4">
                      ...
                      <div className="col-md-6">
                        ...
                        <div className="border rounded p-4" style={{maxHeight: '200px', overflowY: 'auto'}}>
                          {teachers.length === 0 ? (
                            <p className="text-muted mb-0 small">No teachers available</p>
                          ) : (
